...
class SegmentInMemoryImpl {
  public:
    ...
    using BlockConfigPerColumn = std::vector<DetachableBlockConfig>;
    ...
    size_t on_descriptor_change(
            ...
            Sparsity allow_sparse, const std::optional<BlockConfigPerColumn>& block_config_per_column = std::nullopt
    );
